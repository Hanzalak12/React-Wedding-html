...
require("../src/css/flexslider.css");
require("../src/css/magnific-popup.css");
// require("../src/css/owl.carousel.min.css");
require("../src/css/owl.theme.default.min.css");
require("../src/css/style.css");
// require("../src/js/jquery.min.js");
require("../src/js/Responce.js");
function visible(id){
  alert("asd")
  if($('#'+id).is(':hidden'))
  {
...
function App() {
  ...
  return (
    ...
    <div id="page" style={{float: 'left', width: '100%'}}>
              ...
              <ul>
                ...
                <li className="has-dropdown">
                  ...
                  <ul className="dropdown">
                    <li><a href="#">{'{'}table.property1{'}'}</a></li>
                    <li><a href="#">{'{'}table.property2{'}'}</a></li>
            ...
            <div className="col-md-8 col-md-offset-2 text-center">
              <div className="display-t">
                <div className="display-tc animate-box" data-animate-effect="fadeIn">
                  <h1 id="couple_Name_Tile">Joefreddy &amp; Sheila</h1>
      ...
      <input type="checkbox" onChange={()=>{visible('fh5co-couple');}} style={{position: 'sticky'}} defaultChecked="true" />couple Section
      <div id="fh5co-couple">
        <div className="container">
          <div className="row">
            <div className="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
              <h2>Hello!</h2>
              <h3 id="complete_Date_Title">November 28th, 2016 New York, USA</h3>
          ...
          <div className="couple-wrap animate-box">
            <div className="couple-half">
              <div className="groom">
                <img id="groom_Main_Image" src="images/groom.jpg" alt="groom" className="img-responsive" />
              </div>
              <div className="desc-groom">
                <h3 id="groom_Name_Title">Joefrey Mahusay</h3>
                <p id="groom_Description">Far far away, behind the word mountains, far from the countries
            ...
            <div className="couple-half">
              <div className="bride">
                <img id="bride_Main_Image" src="images/bride.jpg" alt="groom" className="img-responsive" />
              </div>
              <div className="desc-bride">
                <h3 id="bride_Name_Title">Sheila Mahusay</h3>
                <p id="bride_Description">Far far away, behind the word mountains, far from the countries
                  Vokalia and Consonantia, there live the blind texts. Separated they live in
                  Bookmarksgrove</p>
              </div>
            </div>
      ...
      <input type="checkbox" onChange={()=>{visible('fh5co-event')}} style={{position: 'sticky'}} defaultChecked="true" />event Section
          ...
          <div className="row">
            <div className="display-t">
              <div className="display-tc">
                <div className="col-md-10 col-md-offset-1" id="events_Detail">
      ...
      <input type="checkbox" onChange={()=>{visible('fh5co-couple-story')}} style={{position: 'sticky'}} defaultChecked="true" />couple-story Section
            ...
            <div className="col-md-12 col-md-offset-0">
              <ul className="timeline animate-box">
                <li className="animate-box">
                  <div className="timeline-badge" id="first_Meet_Story_Image" />
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h3 className="timeline-title">First We Meet</h3>
                      <span className="date" id="first_We_Meet_Date">December 25, 2015</span>
                    </div>
                    <div className="timeline-body">
                      <p id="first_We_Meet_Story">Far far away, behind the word mountains, far from
                ...
                <li className="timeline-inverted animate-box">
                  <div className="timeline-badge" id="first_Date_Story_Image" />
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h3 className="timeline-title">First Date</h3>
                      <span className="date" id="first_Date_Date">December 28, 2015</span>
                    </div>
                    <div className="timeline-body">
                      <p id="first_Date_Story">Far far away, behind the word mountains, far from the
                ...
                <li className="animate-box">
                  <div className="timeline-badge" id="relationship_Story_Image" />
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h3 className="timeline-title">In A Relationship</h3>
                      <span className="date" id="relationship_Date">January 1, 2016</span>
                    </div>
                    <div className="timeline-body">
                      <p id="relationship_Story">Far far away, behind the word mountains, far from the
                        countries Vokalia and Consonantia, there live the blind texts. Separated
                        they live in Bookmarksgrove right at the coast of the Semantics, a large
                        language ocean.</p>
                    </div>
      ...
      <input type="checkbox" onChange={()=>{visible('fh5co-gallery')}} style={{position: 'sticky'}} defaultChecked="true" />gallery Section
      ...
      <input type="checkbox" onChange={()=>{visible('fh5co-testimonial')}} style={{position: 'sticky'}} defaultChecked="true" />testimonial Section
            ...
            <div className="row">
              <div className="col-md-12 animate-box">
                <div className="wrap-testimony">
                  <div className="owl-carousel-fullwidth" id="friends_Comments">
                    <div className="item">
      ...
      <input type="checkbox" onChange={()=>{visible('fh5co-services')}} style={{position: 'sticky'}} defaultChecked="true" />services Section
      ...
      <input type="checkbox" onChange={()=>{visible('fh5co-started')}} style={{position: 'sticky'}} defaultChecked="true" />started Section
        ...
        <div className="container">
          <div className="row copyright">
            <div className="col-md-12 text-center">
              <p>
                <small className="block">© 2016 Free HTML5. All Rights Reserved.</small>
